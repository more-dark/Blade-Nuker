...
- This script is educational and fully coded by T-D Organisation (Team-Dark)
- if you choose to abuse this tool it's are your fault and Team-Dark will not accept anything about you're mistake


✨ Bruh Nuker. A defferant nuker that you can enjoy it cool featchurs ✨
- T-D Organisation (Team Dark)
...
def print_banner():
    """Print beautiful banner for input prompts"""
    banner = f"""
...
def start(args):
    ...
    System.Clear()
    System.Title("Discord Nuker - https://discord.gg/dera")
    System.Size(160, 40)

    # Print beautiful banner before asking for inputs
    print_banner()

    if not token:
        # Styled input for token
        print(f"\n{Colorate.Vertical(Colors.DynamicMIX((Col.light_red, Col.red)), '╔══════════════════════════════════════════════════════════════╗')}")
    ...
    # Styled guild list header
    print(f"{Colorate.Vertical(Colors.DynamicMIX((Col.light_red, Col.red)), '╔══════════════════════════════════════════════════════════════╗')}")
    print(f"{Colorate.Vertical(Colors.DynamicMIX((Col.light_red, Col.red)), '║                    📡 AVAILABLE GUILDS 📡                    ║')}")
    print(f"{Colorate.Vertical(Colors.DynamicMIX((Col.light_red, Col.red)), '╚══════════════════════════════════════════════════════════════╝')}")
    print()
    ...
    print()
    print(f"{Colorate.Vertical(Colors.DynamicMIX((Col.light_red, Col.red)), '╔══════════════════════════════════════════════════════════════╗')}")
    print(f"{Colorate.Vertical(Colors.DynamicMIX((Col.light_red, Col.red)), '║                    🎯 SELECT GUILD ID 🎯                     ║')}")
    print(f"{Colorate.Vertical(Colors.DynamicMIX((Col.light_red, Col.red)), '╚══════════════════════════════════════════════════════════════╝')}")
    guild = Funcs.get_input(f"\n{Fore.RED}➤{Fore.CYAN} Enter Guild ID or Number{Fore.YELLOW} » {Fore.WHITE}", lambda x: x.isnumeric() and (x in str(_guilds) or x in Tools.get_guilds(token)[0] ))
